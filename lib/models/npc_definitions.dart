  ...
  static List<NpcData> createTownNpcs() {
    ...
    return [
      ...
      NpcData(
        ...
        x: 30, y: 11, gold: 12 + rng.nextInt(8), maxGold: 20,
        diceChance: 0.4,
      ),
      NpcData(
        id: 'merchant_02', name: 'Silka',
        type: NpcType.merchant, personality: Personality.bold,
        x: 35, y: 11, gold: 8 + rng.nextInt(6), maxGold: 16,
        diceChance: 0.35,
      ),
      ...
      NpcData(
        ...
        x: 18, y: 20, gold: 4 + rng.nextInt(3), maxGold: 8,
        diceChance: 0.2,
      ),
      NpcData(
        id: 'guard_02', name: 'Brynn',
        type: NpcType.guard, personality: Personality.normal,
        x: 35, y: 20, gold: 4 + rng.nextInt(4), maxGold: 8,
        diceChance: 0.25,
      ),
      ...
      NpcData(
        ...
        x: 6, y: 11, gold: 20 + rng.nextInt(30), maxGold: 50,
        diceChance: 0.5,
      ),
      ...
      NpcData(
        ...
        x: 35, y: 19, gold: 6 + rng.nextInt(5), maxGold: 12,
        diceChance: 0.3,
      ),
      ...
      NpcData(
        ...
        x: 5, y: 20, gold: 2 + rng.nextInt(2), maxGold: 5,
        diceChance: 0.5,
      ),
      NpcData(
        id: 'farmer_02', name: 'Rosie',
        type: NpcType.farmer, personality: Personality.cautious,
        x: 11, y: 30, gold: 2 + rng.nextInt(2), maxGold: 4,
        diceChance: 0.45,
      ),
      ...
      NpcData(
        ...
        x: 18, y: 19, gold: 3 + rng.nextInt(3), maxGold: 8,
        diceChance: 0.55,
      ),
      NpcData(
        id: 'barmaid_02', name: 'Mae',
        type: NpcType.barmaid, personality: Personality.normal,
        x: 11, y: 19, gold: 2 + rng.nextInt(2), maxGold: 6,
        diceChance: 0.5,
      ),
