...
class TownMap {
  ...
  static List<List<TileType>> generate() {
    ...
    // Stall rows — with gaps for NPC movement
    set(29, 14, T.stall); set(30, 14, T.stall);
    set(36, 14, T.stall); set(37, 14, T.stall);
    set(29, 17, T.stall); set(30, 17, T.stall);
    set(36, 17, T.stall); set(37, 17, T.stall);
    // Crates and barrels at corners only
    set(28, 13, T.crate); set(38, 18, T.crate);
    // ── DICE TABLE 2 — market center, wide open space around it ──
    set(33, 16, T.diceTable);
    set(32, 16, T.chair); set(34, 16, T.chair);
    ...
    // ── DICE TABLE 5 — outside blacksmith, clear courtyard ──
    set(33, 21, T.diceTable);
    set(32, 21, T.chair); set(34, 21, T.chair);
    ...
    // ── DICE TABLE 6 — south park area (clear of buildings) ──
    set(22, 33, T.diceTable);
    set(21, 33, T.chair); set(23, 33, T.chair);
    // Connect to south road
    fill(22, 31, 22, 32, T.path);
